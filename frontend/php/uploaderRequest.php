...
<body>
    <div class="form-container">
        ...
        <form id="uploaderRequestForm" action="processos/processar_pedido.php" method="POST" enctype="multipart/form-data"> <!-- Motivação -->
            ...
            <div class="form-group">
                ...
                <input type="file" id="photoUploads" name="photoUploads[]" accept="image/*" multiple required> <small>Por favor, faça o upload de exatamente 3 fotos (JPG, PNG).</small>
            </div>
